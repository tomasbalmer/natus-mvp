import modalitiesRaw from '@data/modalities.json';
import topicsRaw from '@data/topics.json';
import crisisRaw from '@data/crisis-resources.json';
import bedsRaw from '@data/bed-tracks.json';
import needsRaw from '@data/presenting-needs.json';
import opennessRaw from '@data/openness-options.json';

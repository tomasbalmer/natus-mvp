...
/** The client, carrying the schema generated by `pnpm gen:types`. Typing it
 *  is what makes src/store/remote.ts a checked mapping rather than a hopeful
 *  one — every column name and every nullability below is verified. */
 ...
 */
export const supabase: TypedClient | null = create();
